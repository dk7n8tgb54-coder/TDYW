...
if os.path.exists(mysql_data_path):
    ...
    print("   OPTIMIZE TABLE tdyw_duty_records;")
    print("   OPTIMIZE TABLE tdyw_fault_parts;")
    print("   OPTIMIZE TABLE tdyw_fault_records;")
    print("   OPTIMIZE TABLE tdyw_interferences;")
    print("   OPTIMIZE TABLE tdyw_run_logs;")
    print("   OPTIMIZE TABLE tdyw_schedule;")
    print("   OPTIMIZE TABLE tdyw_schedule_swap;")
