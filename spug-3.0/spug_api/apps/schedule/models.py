...
class ScheduleShift(models.Model, ModelMixin):
    """班次规则"""
    TENANT_TYPE = TENANT_TYPE_PRIVATE
    tenant_id = models.CharField(max_length=50, default='', help_text='租户标识')
...
class ScheduleShiftTime(models.Model, ModelMixin):
    """班次时间配置"""
    TENANT_TYPE = TENANT_TYPE_PRIVATE
    tenant_id = models.CharField(max_length=50, default='', help_text='租户标识')
    ...
    class Meta:
        db_table = 'exec_schedule_shift_time'
...
class ScheduleSubstitute(models.Model, ModelMixin):
    """替班记录"""
    TENANT_TYPE = TENANT_TYPE_PRIVATE
    tenant_id = models.CharField(max_length=50, default='', help_text='租户标识')
    ...
    class Meta:
        db_table = 'exec_schedule_substitute'
        ordering = ('-created_at', '-id',)
        # P1-3: 添加复合索引优化查询性能
        indexes = [
