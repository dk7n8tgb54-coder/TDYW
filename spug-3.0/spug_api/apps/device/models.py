...
class DeviceResume(models.Model, TenantModelMixin):
    ...
    frequency = models.CharField(max_length=30, blank=True, help_text='工作频率', default='')
    call_sign = models.CharField(max_length=30, blank=True, help_text='设备呼号', default='')
    install_location = models.CharField(max_length=200, help_text='安装地点')
    geo_coordinate = models.CharField(max_length=100, blank=True, help_text='安装经纬度，格式: 经度,纬度', default='')
    device_purpose = models.TextField(blank=True, max_length=500, help_text='设备用途', default='')
    ...
    remark = models.TextField(blank=True, max_length=1000, help_text='备注', default='')
...
class DeviceEvent(models.Model, TenantModelMixin):
    ...
    fault_part = models.CharField(max_length=100, blank=True, help_text='故障件（仅检修类型）', default='')
    fault_phenomenon_cause = models.TextField(blank=True, max_length=1000, help_text='故障现象及原因（仅检修类型）', default='')
    maintenance_measures = models.TextField(blank=True, max_length=2000, help_text='检修措施（仅检修类型）', default='')
    ...
    remark = models.TextField(blank=True, max_length=500, help_text='备注', default='')
