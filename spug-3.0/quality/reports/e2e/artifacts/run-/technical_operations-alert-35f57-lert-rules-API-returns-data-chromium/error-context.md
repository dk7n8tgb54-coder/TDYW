...
- Name: technical_operations\alert.spec.js >> System Alert - Technical Operations >> ALT004 - Alert rules API returns data
- Location: tests\technical_operations\alert.spec.js:37:3
