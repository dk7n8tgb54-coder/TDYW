...
(191,'admin','default','172.20.0.1','PC / Windows 10 / Edge 144.0.0',NULL,1,'2026-01-31 21:44:05'),
(192,'admin','default','172.20.0.1','PC / Windows 10 / Edge 144.0.0',NULL,1,'2026-01-31 21:50:44'),
(193,'admin','default','172.20.0.1','PC / Windows 10 / Edge 144.0.0',NULL,1,'2026-01-31 21:51:35');
...
CREATE TABLE `roles` (
  ...
  `created_at` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_by_id` int(11) NOT NULL,
  `is_global_admin` tinyint(1) DEFAULT 0 COMMENT 'è¯¥è§’è‰²ç”¨æˆ·å¯æŸ¥çœ‹æ‰€æœ‰ç§Ÿæˆ·æ•°æ®',
  PRIMARY KEY (`id`),
...
(5,'admin','管理员','pbkdf2_sha256$150000$z89pYxkiYBut$jQn+ZIakdLJUGtb0ERPUBY3h0EJ5+Mul3FCqgebvjzQ=','default',1,1,'4f4c3b70bdb044c682f28f311adfd21f',1769896305,'2026-01-31 21:51:35','172.20.0.1',NULL,'2026-01-20 04:24:23',NULL,NULL,NULL),
...
-- Dump completed on 2026-01-31 14:01:57
