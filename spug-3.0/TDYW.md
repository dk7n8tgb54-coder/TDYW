...
本项目基于 Spug 运维自动化平台进行定制开发，主要服务于文档管理、设备管理等功能。
...
**秒传检查结构化日志（已废弃）：**
- 跨 transfer 哈希复用（秒传）功能已于 2026-08-07 移除，当前版本仅支持断点续传
- 上述日志和缓存逻辑不再生效
...
| 秒传检查（已移除） | — | ⛔ 已移除 | 跨 transfer 哈希复用于 2026-08-07 移除，仅保留断点续传 | — |
